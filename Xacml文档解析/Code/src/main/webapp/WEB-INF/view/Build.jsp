    ...
    <script type="text/javascript">
        function save(){
            $.ajax({
                ...
                "version":$("#vresion").val(),
                "RulecombiningAigId":$("#RulecombiningAigId option:selected").text(),
                ...
                "MatchId1":$("#MatchId1").val(),
                    ...
                    "RuleId":encodeURI($("#RuleId").val()),
                    "Effect":$("#Effect").val(),
                    "description2":encodeURI($("#description2").val()),

                    "MatchId4":$("#MatchId4").val(),
                    "DataType4":$("#DataType4").val(),
                    "value4":encodeURI($("#value4").val()),

                    "MatchId5":$("#MatchId5").val(),
                    "DataType5":$("#DataTye5").val(),
                    "value5":encodeURI($("#value5").val()),

                    "MatchId6":$("#MatchId6").val(),
                    "DataType6":$("#DataType6").val(),
                    "value6":encodeURI($("#value6").val()),
                },
                type:"GET",
    ...
    <div class="row">
        <div class="col-lg-2" style=" background: #005cbf; height: 600px; text-align: center;">
            <div style="margin-top: 20px;">
                ...
                <button class="btn btn-default" id="delete" onclick="delete2();">删除策略</button>
            </div>
        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label for="vresion" class="col-sm-2 control-label">version</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" id="RulecombiningAigId">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <textarea class="form-control" rows="3" id="description2"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">MatchId</label>
                                                            <div class="col-sm-10">
                                                                <select class="form-control" id="MatchId4">
                                                                    <option value="null">null</option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-equal</option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:boolean-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-equal</option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dayTimeDuration-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-equal-ignore-case </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:anyURI-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:x500Name-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:hexBinary-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:base64Binary-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-add </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-add </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-subtract </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-subtract </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-multiply </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-multiply </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-divide </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-divide </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-mod </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-abs </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-abs </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:round </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:floorurn:oasis:names:tc:xacml:1.0:function:string-normalize-space </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-normalize-to-lower-case </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-to-integer </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-to-double </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:or </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:and </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:n-of </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:noturn:oasis:names:tc:xacml:1.0:function:integer-greater-than </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-greater-than-or-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-less-than </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-less-than-or-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-greater-than </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-greater-than-or-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-less-than </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-less-than-or-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dateTime-add-dayTimeDuration </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dateTime-add-yearMonthDuration </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dateTime-subtract-dayTimeDuration  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dateTime-subtractyearMonthDuration </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:date-add-yearMonthDuration </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:date-subtract-yearMonthDuration </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-greater-than </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-greater-than-or-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-less-than </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-less-than-or-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-greater-than </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-greater-than-or-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-less-than </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-less-than-or-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:2.0:function:time-in-range </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-greater-than </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-greater-than-or-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-less-than </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-less-than-or-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-greater-than </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-greater-than-or-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-less-than </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-less-than-or-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:boolean-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:boolean-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:boolean-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:boolean-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-bag-size</option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:anyURI-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:anyURI-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:anyURI-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:anyURI-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:hexBinary-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:hexBinary-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:hexBinary-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:hexBinary-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:base64Binary-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:base64Binary-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:base64Binary-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:base64Binary-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dayTimeDuration-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dayTimeDuration-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dayTimeDuration-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dayTimeDuration-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:x500Name-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:x500Name-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:x500Name-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:x500Name-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:rfc822Name-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:rfc822Name-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:rfc822Name-is-in </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:rfc822Name-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:2.0:function:ipAddress-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:2.0:function:ipAddress-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:2.0:function:ipAddress-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:2.0:function:dnsName-one-and-only </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:2.0:function:dnsName-bag-size </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:2.0:function:dnsName-bag </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:2.0:function:string-concatenate </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:boolean-from-string </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-from-boolean </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:integer-from-string </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-from-integer </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:double-from-string</option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-from-double </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:time-from-string </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-from-time </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:date-from-string </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-from-date </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dateTime-from-string </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-from-dateTime </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:anyURI-from-string </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-from-anyURI </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dayTimeDuration-from-string </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-from-dayTimeDuration </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-from-string </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-from-yearMonthDuration </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:x500Name-from-string </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-from-x500Name </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:rfc822Name-from-string </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-from-rfc822Name </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:ipAddress-from-string </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-from-ipAddress </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dnsName-from-string </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-from-dnsName </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-starts-with </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:anyURI-starts-with </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-ends-with </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:anyURI-ends-with </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-contains </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:anyURI-contains </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:string-substring </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:anyURI-substring </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:any-of </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:all-of </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:any-of-any </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:all-of-any </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:any-of-all  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:all-of-all  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:map </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:x500Name-match  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:rfc822Name-match  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-regexp-match  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:2.0:function:anyURI-regexp-match  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:2.0:function:ipAddress-regexp-match  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:2.0:function:dnsName-regexp-match  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:2.0:function:rfc822Name-regexp-match  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:2.0:function:x500Name-regexp-match  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:xpath-node-count </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:xpath-node-equal </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:xpath-node-match </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-intersection </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-at-least-one-member-of </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-union </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-subset </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:string-set-equals </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:boolean-intersection </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:boolean-at-least-one-member-of </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:boolean-union </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:boolean-subset </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:boolean-set-equals </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-intersection</option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-at-least-one-member-of  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-union  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-subset  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:integer-set-equals  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-intersection  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-at-least-one-member-of  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-union  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-subset  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:double-set-equals  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-intersection  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-at-least-one-member-of  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-union  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-subset  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:time-set-equals  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-intersection  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-at-least-one-member-of  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-union  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-subset  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:date-set-equals  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-intersection  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-at-least-one-member-of  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-union  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-subset  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:dateTime-set-equals  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:anyURI-intersection  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:anyURI-at-least-one-member-of  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:anyURI-union  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:anyURI-subset  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:anyURI-set-equals  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:hexBinary-intersection  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:hexBinary-at-least-one-member-of  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:hexBinary-union  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:hexBinary-subset  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:hexBinary-set-equals  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:base64Binary-intersection  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:base64Binary-at-least-one-memberof  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:base64Binary-union  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:base64Binary-subset  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:base64Binary-set-equals  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dayTimeDuration-intersection  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dayTimeDuration-at-least-onemember-of  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dayTimeDuration-union  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dayTimeDuration-subset  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:dayTimeDuration-set-equals  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-intersection  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-at-least-onemember-of  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-union  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-subset  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-set-equals  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:x500Name-intersection  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:x500Name-at-least-one-member-of  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:x500Name-union  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:x500Name-subset  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:x500Name-set-equals  </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:rfc822Name-intersection </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:rfc822Name-at-least-one-member-of </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:rfc822Name-union </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:rfc822Name-subset </option>
                                                                    <option value="">urn:oasis:names:tc:xacml:1.0:function:rfc822Name-set-equals </option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">Data Type</label>
                                                            <div class="col-sm-10">
                                                                <select class="form-control" id="DataType4">
                                                                    <option value="null">null</option>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="value4" class="col-sm-2 control-label">value</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" id="value4" placeholder="null">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">MatchId</label>
                                                            <div class="col-sm-10">
                                                                <select class="form-control" id="MatchId5">
                                                                    <option value="null">null</option>
                                                                    <option value="urn:oasis:names:tc:xacml:1.0:function:string-equal">urn:oasis:names:tc:xacml:1.0:function:string-equal</option>
                                                                    <option value="urn:oasis:names:tc:xacml:1.0:function:boolean-equal">urn:oasis:names:tc:xacml:1.0:function:boolean-equal </option>
                                                                    <option value="urn:oasis:names:tc:xacml:1.0:function:integer-equal">urn:oasis:names:tc:xacml:1.0:function:integer-equal </option>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">Data
                                                                Type</label>
                                                            <div class="col-sm-10">
                                                                <select class="form-control" id="DataType5">
                                                                    <option value="null">null</option>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="value5" class="col-sm-2 control-label">value</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" id="value5" placeholder="null">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">MatchId</label>
                                                            <div class="col-sm-10">
                                                                <select class="form-control" id="MatchId6">
                                                                    <option value="null">null</option>
                                                                    <option value="urn:oasis:names:tc:xacml:1.0:function:string-equal">urn:oasis:names:tc:xacml:1.0:function:string-equal</option>
                                                                    <option value="urn:oasis:names:tc:xacml:1.0:function:boolean-equal">urn:oasis:names:tc:xacml:1.0:function:boolean-equal </option>
                                                                    <option value="urn:oasis:names:tc:xacml:1.0:function:integer-equal">urn:oasis:names:tc:xacml:1.0:function:integer-equal </option>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">Data
                                                                Type</label>
                                                            <div class="col-sm-10">
                                                                <select class="form-control" id="DataType6">
                                                                    <option value="null">null</option>
                                                                    <option value="http://www.w3.org/2001/XMLSchema#string">http://www.w3.org/2001/XMLSchema#string</option>
                                                                    <option value="http://www.w3.org/2001/XMLSchema#boolean">http://www.w3.org/2001/XMLSchema#boolean</option>
                                                                    <option value="http://www.w3.org/2001/XMLSchema#integer">http://www.w3.org/2001/XMLSchema#integer</option>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="value6" class="col-sm-2 control-label">value</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" id="value6" placeholder="null">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
