...
typedef struct _ConfigNode__isset {
  _ConfigNode__isset() : file(false), swimlane(false), cell(false) {}
  bool file;
  bool swimlane;
  bool cell;
} _ConfigNode__isset;
...
class ConfigNode {
 public:
  ...
  static const char* ascii_fingerprint; // = "6687457942FF7B3BE3FD26915A2579B0";
  static const uint8_t binary_fingerprint[16]; // = {0x66,0x87,0x45,0x79,0x42,0xFF,0x7B,0x3B,0xE3,0xFD,0x26,0x91,0x5A,0x25,0x79,0xB0};

  ConfigNode() : appkey(""), env(""), path(""), swimlane(""), cell("") {
  }
...
typedef struct _GetMergeDataRequest__isset {
  _GetMergeDataRequest__isset() : swimlane(false), cell(false) {}
  bool swimlane;
  bool cell;
...
class GetMergeDataRequest {
 public:
  ...
  static const char* ascii_fingerprint; // = "9AA980B7DB23D0B60098B4FD229E121F";
  static const uint8_t binary_fingerprint[16]; // = {0x9A,0xA9,0x80,0xB7,0xDB,0x23,0xD0,0xB6,0x00,0x98,0xB4,0xFD,0x22,0x9E,0x12,0x1F};

  GetMergeDataRequest() : appkey(""), env(""), path(""), version(0), requestIp(""), swimlane(""), cell("") {
  }
...
typedef struct _ConfigFileResponse__isset {
  _ConfigFileResponse__isset() : hosts(false), codes(false) {}
  bool hosts;
  bool codes;
...
class ConfigFileResponse {
 public:
  ...
  static const char* ascii_fingerprint; // = "A4F69D484F8D9346BDDB76565BB5535F";
  static const uint8_t binary_fingerprint[16]; // = {0xA4,0xF6,0x9D,0x48,0x4F,0x8D,0x93,0x46,0xBD,0xDB,0x76,0x56,0x5B,0xB5,0x53,0x5F};
  ...
  void __set_codes(const std::map<std::string, int32_t> & val) {
    codes = val;
    __isset.codes = true;
  }
  ...
  bool operator == (const ConfigFileResponse & rhs) const
  {
    ...
    if (__isset.hosts != rhs.__isset.hosts)
      ...
      return false;
    if (__isset.codes != rhs.__isset.codes)
      return false;
    else if (__isset.codes && !(codes == rhs.codes))
      return false;
    return true;
  }
  bool operator != (const ConfigFileResponse &rhs) const {
