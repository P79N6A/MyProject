...
public class Page implements Cloneable {
    ...
    private void calculateTotalPageCount(int maxPageCount) {
        totalPageCount = totalCount / pageSize;
        if (totalCount % pageSize > 0) {
            totalPageCount++;
        }
        totalPageCount = totalPageCount > maxPageCount ? maxPageCount : totalPageCount;
    ...
    public void setTotalCount(int totalCount) {
        this.totalCount = totalCount;
        // 计算总页数
        calculateTotalPageCount(Integer.MAX_VALUE);
    }

    public void setTotalCount(int totalCount, int maxPageCount) {
        this.totalCount = totalCount;
        // 计算总页数
        calculateTotalPageCount(maxPageCount);
    }
