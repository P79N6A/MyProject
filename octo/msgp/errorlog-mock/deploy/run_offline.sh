...
JVM_HEAP="-XX:SurvivorRatio=4 -XX:PermSize=256m -XX:MaxPermSize=256m -XX:+HeapDumpOnOutOfMemoryError -XX:ReservedCodeCacheSize=128m -XX:InitialCodeCacheSize=128m"
JVM_SIZE="-Xmx6g -Xms6g -Xmn3g -Xss256k"
...
# do not edit
# ------------------------------------
MODULE=errorlog-mock
WORK_PATH=/opt/meituan/apps/errorlog-mock
LOG_PATH=/opt/logs/apps/errorlog-mock
...
function run() {
	...
	$EXEC_JAVA com.sankuai.mms.boot.Bootstrap &>/tmp/errorlog.mock.log
}
