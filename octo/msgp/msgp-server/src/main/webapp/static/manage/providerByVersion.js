M.add('msgp-manage/providerByVersion', function (Y) {
    Y.namespace('msgp.manage').providerByVersion = providerByVersion;
    var appkey = "aaa";
    var lwrap = Y.one('#body_wrap'),
    ...
    function providerByVersion(version, envId,thrifttype) {
        var url = '/manage/provideBythriftVersion?version=' + version + '&envId=' + envId + "&thrifttype=" + thrifttype;
        Y.io(url, {
            method : 'get',
            on : {
