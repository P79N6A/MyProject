...
M.add('msgp-utils/tableSorter', function (Y, NAME){
    var msgp_utils = Y.namespace("msgp.utils");
    ...
    TableSorter.prototype = {
        ...
        Init : function(args)//初始化表格的信息和操作
        {
            ...
            this.NormalCss = "fa fa-sort";
            this.SortAscCss = "fa fa-sort-asc";
            this.SortDescCss = "fa fa-sort-desc";
        ...
        Sort : function(column)//执行排序.
        {
            if(this.LastSorted)
            {
                this.LastSorted.lastChild.className = this.NormalCss;
            }
            ...
            if(this.ViewState[column])
            {
                ...
                this.Header[column].lastChild.className = this.SortDescCss;
            }
            else
            {
                this.ViewState[column] = true;
                this.Header[column].lastChild.className = this.SortAscCss;
            }
    ...
    msgp_utils.TableSorter = TableSorter;
}, '0.0.1', {
