...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="tab-box">
        <ul class="nav nav-tabs widget-edit-tab">
            ...
            <li class="current"><a href="/tair">缓存大盘</a></li>
        </ul>
    </div>
</div>
...
<div id="triggers_wrap">
    <div class="form-inline mb20">
        ...
        <div style="float: right;margin-bottom: 20px">
            <span>汇聚了所有缓存主机的监控，点击报警数查看详情。</span>
            <a href="https://123.sankuai.com/km/page/28355031" target="_blank">缓存大盘使用说明<i
    ...
    <script type="text/javascript" src="/static/dashboard/tair.js"></script>
</div>