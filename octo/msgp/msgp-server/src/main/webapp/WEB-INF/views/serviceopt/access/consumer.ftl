<div class="form-horizontal">
    ...
    <div class="control-group"><label class="control-label" style="width: 125px;">主机：</label>
        ...
        <div class="controls" style="margin-left: 0px;">
            <div class="input-append">
                <textarea id="access_add_ip" class="span4" placeholder="IP地址" type="text" style="height: 25px;"></textarea>
                <button id="access_add_ip_btn" class="btn btn-primary" style="height: 35px;margin-left: -1px;"
    ...
    <div class="control-group">
        ...
        <div class="controls" style="margin-left: 0px;">
            ...
            <span style="color: red;">编辑后请保存,确保"启用"才生效</span>
        </div>
    </div>
</div>
