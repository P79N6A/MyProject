<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="div_cmpt_version"></div>
<textarea id="text_cmpt_version" style="display:none"><table style="width: 100%;">
    <tr>
      <td style="vertical-align: top; padding-top: 20px; width: 1030px; padding-bottom: 30px;">
          <div id="cmpt_version_tips" class="charts-wrapper" style="width: 800px;height: auto;border: 0;"></div>
          <div id="cmpt_version_charts" class="charts-wrapper" style="width: 800px;height: 400px;border: 0;"></div>
      </td>
      <td rowspan="2" style="vertical-align: top; width: 310px; padding-top: 20px; padding-bottom: 30px;">
        <table>
          <tbody>
            <#--<tr>
              <td colspan="2">
                  <input id="start" type="text" class="span2" placeholder="开始日期" disabled="disabled" style="color: #d0d0d0">
                      <span> - </span>
                  <input id="end" type="text" class="span2" placeholder="结束日期" disabled="disabled" style="color: #d0d0d0">
              </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
              ...
              <td>
                  <input id="groupId" name="groupId" type="text" value="${groupId}" title="groupId" style="width: 200px;" placeholder="输入关键字选择 或 输入完整值" />
              </td>
            </tr>
            <tr>
              <td style="text-align: right;">
              ...
              <td>
                  <input id="artifactId" name="artifactId" type="text" value="${artifactId}" title="artifactId" style="width: 200px;" placeholder="输入关键字选择 或 输入完整值"/>
              </td>
            </tr>
            <tr>
                <td colspan="2">
    ...
    <tr>
        <td style="vertical-align: top; width: 100%; padding-top: 30px; padding-bottom: 50px" colspan="2">
            <div style="height:auto; width: 100%;" id="version_list_wrapper"></div>
             <div id="paginator_version"></div>
            <div id="paginator_version_wrapper" style="padding-right: 50px;"></div>
      </td>
    </tr>
  </table>
</textarea>
