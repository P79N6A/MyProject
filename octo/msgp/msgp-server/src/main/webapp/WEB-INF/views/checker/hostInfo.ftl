<div class="form-horizontal">
    ...
    <div id = "detail_div" >
        ...
        <div class="control-group" style="margin-bottom: 10px;"><label id="monitor_res_label" class="control-label detail-label" style="width: 125px;">monitor：</label>
            ...
            <div class="controls" style="margin-left: 0px;">
                <a class="outline-content detail-content" id="monitor_res_content"></a>
                <#--<span class="outline-content detail-content" >无</span>-->
            </div>
        </div>
        ...
        <div class="control-group" style="margin-bottom: 10px;"><label id="sys_resource_res_label" class="control-label detail-label" style="width: 125px;">磁盘状态：</label>

            <div id="sys_resource_res_loading" class="detail-loading">
                <i class="fa fa-spinner fa-spin text-blue"></i><span class="ml20">获取数据中...</span>
            </div>
            <div class="controls" style="margin-left: 0px;">
                <span class="outline-content detail-content" id="sys_resource_res_content">无</span>
            </div>
        </div>

        <div class="control-group" style="margin-bottom: 10px;"><label id="ipvlan_res_label" class="control-label detail-label" style="width: 125px;">网段状态：</label>

            <div id="ipvlan_res_loading" class="detail-loading">
                <i class="fa fa-spinner fa-spin text-blue"></i><span class="ml20">获取数据中...</span>
            </div>
            <div class="controls" style="margin-left: 0px;">
                <span class="outline-content detail-content" id="ipvlan_res_content">无</span>
            </div>
        </div>
