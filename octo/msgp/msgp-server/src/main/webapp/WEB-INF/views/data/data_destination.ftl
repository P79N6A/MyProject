<title>去向分析</title>
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="div_data_destination"></div>
<textarea id="text_data_destination" style="display:none">
    <div class="form-inline mb20" style="padding: 0;">
        <div class="control-group" style="display: inline-block; white-space: nowrap;">
            ...
            <div id="destination_env_select" class="btn-group">
            ...
            <label style="margin-left: 5px"> 开始：</label><input id="start_time" value="${start}" type="text" class="span3" placeholder="查询开始时间" style="width: 160px;">
            <label style="margin-left: 5px"> 结束：</label><input id="end_time"  value="${end}" type="text" class="span3" placeholder="查询结束时间" style="width: 160px;">
    ...
    <hr>
    <div class="destination_kpi_list clearfix" style="text-align: center;"></div>
</textarea>
