 ...
 *  @generated
 */
#ifndef MtConfig_TYPES_H
#define MtConfig_TYPES_H
...
typedef struct _file_param_t__isset {
  _file_param_t__isset() : env(false), path(false), cmd(false), err(false), configFiles(false) {}
  bool env;
  bool path;
  bool cmd;
  bool err;
...
class file_param_t {
 public:
  ...
  static const char* ascii_fingerprint; // = "2AB6665D4AB458537C94B80533FA0FE3";
  static const uint8_t binary_fingerprint[16]; // = {0x2A,0xB6,0x66,0x5D,0x4A,0xB4,0x58,0x53,0x7C,0x94,0xB8,0x05,0x33,0xFA,0x0F,0xE3};

  file_param_t() : appkey(""), env(""), path(""), cmd(0), err(0) {
  }
...
class ConfigFileRequest {
 public:
  ...
  static const char* ascii_fingerprint; // = "25608C7CED5C1200299288D027CF8CA3";
  static const uint8_t binary_fingerprint[16]; // = {0x25,0x60,0x8C,0x7C,0xED,0x5C,0x12,0x00,0x29,0x92,0x88,0xD0,0x27,0xCF,0x8C,0xA3};
