...
public class SerializationUtils {
    ...
    public static String toBase64String(Serializable o) {
        ...
        return new String(Base64.encode(serialize(o)));
    }
    ...
    public static Object fromBase64String(String s) {
        ...
        return deserialize(Base64.decode(s));
    }

    //*********************** copy from commons-lang 2.5
     ...
     * @throws com.sankuai.meituan.config.exception.SerializationException (runtime) if the serialization fails
     */
    ...
    public static void serialize(Serializable obj, OutputStream outputStream) {
        ...
        try {
            ...
            throw new com.sankuai.meituan.config.exception.SerializationException(ex);
        } finally {
            try {
                if (out != null) {
                    out.close();
