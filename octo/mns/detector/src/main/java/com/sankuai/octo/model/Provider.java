package com.sankuai.octo.model;
...
public class Provider {
    ...
    private int heartbeatSupport = 0;
    ...
    public static Provider json2Provider(JSONObject json) {
        ...
        if (json.getByte("heartbeatSupport") != null)
            provider.setHeartbeatSupport(json.getByte("heartbeatSupport"));
