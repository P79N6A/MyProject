...
class ProviderQuota:
  ...
  def __init__(self, id=None, name=None, providerAppkey=None, env=None, method=None, QPSCapacity=None, consumerList=None, status=None, watchPeriodInSeconds=thrift_spec[11][4], createTime=None, updateTime=None, alarm=thrift_spec[14][4], degradeEnd=thrift_spec[15][4],):
    self.id = id
    self.name = name
