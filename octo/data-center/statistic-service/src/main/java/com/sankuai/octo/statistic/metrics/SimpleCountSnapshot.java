 ...
 * 耗时与次数 对应的快照数据
 */
public class SimpleCountSnapshot extends Snapshot {
    private static final Logger logger = LoggerFactory.getLogger(SimpleCountSnapshot.class);
     ...
     * @param max 最大耗时 毫秒
     */
        public SimpleCountSnapshot(final TreeMap<Integer, Long> values, long max) {
        this.max = max;
