...
# ------------------------------------------
LOG_ROOT=/opt/logs/mobile/data-aggregator
SRV_ROOT=/service/data-aggregator
RUN_FILE=/opt/meituan/mobile/data-aggregator/deploy/run.sh
CLEANLOG_DATE="3"
APPKEY="data-aggregator"
