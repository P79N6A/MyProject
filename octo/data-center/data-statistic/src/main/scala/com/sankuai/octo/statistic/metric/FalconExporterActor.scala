...
import com.sankuai.octo.statistic.util.{ExecutionContextFactory, Falcon}
...
object FalconExporterActor {
  ...
  private implicit lazy val ec: ExecutionContextExecutor = ExecutionContextFactory.build()
