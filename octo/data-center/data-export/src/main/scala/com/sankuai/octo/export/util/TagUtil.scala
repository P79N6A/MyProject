package com.sankuai.octo.export.util
...
object TagUtil {
  ...
  def getStatTag(spanname: String = Constants.ALL, localHost: String = Constants.ALL,
                 remoteHost: String = Constants.ALL, remoteAppKey: String = Constants.ALL)(implicit infraName: String = PerfProtocolType.THRIFT.toString) = {
