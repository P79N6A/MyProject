...
g++ -O0 -DHAVE_NETINET_IN_H ${SRC_FILE} -I${THRIFT_INCLUDE_DIR} -I${MTRACE_INCLUDE_DIR} -fPIC -shared -o ${MTRACE_LIB_DIR}/libcmtraceV2.so
...
g++ -O0 -g -D HAVE_NETINET_IN_H test.cpp -o ${BIN_FILE} -I${MTRACE_INCLUDE_DIR} -L${LIB_DIR} -L${MTRACE_LIB_DIR} -lcmtraceV2 -pthread -lthrift -luuid
