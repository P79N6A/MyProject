...
const char* SGService::ascii_fingerprint = "5E08793AC822EE642CA77B80A9A98F9E";
const uint8_t SGService::binary_fingerprint[16] = {0x5E,0x08,0x79,0x3A,0xC8,0x22,0xEE,0x64,0x2C,0xA7,0x7B,0x80,0xA9,0xA9,0x8F,0x9E};
...
uint32_t SGService::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 19:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->groupInfo);
          this->__isset.groupInfo = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t SGService::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.groupInfo) {
    xfer += oprot->writeFieldBegin("groupInfo", ::apache::thrift::protocol::T_STRING, 19);
    xfer += oprot->writeString(this->groupInfo);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
const char* proc_conf_param_t::ascii_fingerprint = "7B6EDA1FAE4FACDBB2BB730B023FE013";
const uint8_t proc_conf_param_t::binary_fingerprint[16] = {0x7B,0x6E,0xDA,0x1F,0xAE,0x4F,0xAC,0xDB,0xB2,0xBB,0x73,0x0B,0x02,0x3F,0xE0,0x13};
...
uint32_t proc_conf_param_t::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.cell) {
    xfer += oprot->writeFieldBegin("cell", ::apache::thrift::protocol::T_STRING, 12);
    xfer += oprot->writeString(this->cell);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
...
const char* ConfigUpdateRequest::ascii_fingerprint = "AFA5D0F635711611E206B866BA19A1AC";
const uint8_t ConfigUpdateRequest::binary_fingerprint[16] = {0xAF,0xA5,0xD0,0xF6,0x35,0x71,0x16,0x11,0xE2,0x06,0xB8,0x66,0xBA,0x19,0xA1,0xAC};
...
const char* ProtocolRequest::ascii_fingerprint = "3CF90C4E361EF1D65F82D2A11041508A";
const uint8_t ProtocolRequest::binary_fingerprint[16] = {0x3C,0xF9,0x0C,0x4E,0x36,0x1E,0xF1,0xD6,0x5F,0x82,0xD2,0xA1,0x10,0x41,0x50,0x8A};
...
uint32_t ProtocolRequest::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 7:
        if (ftype == ::apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->enableCell);
          this->__isset.enableCell = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t ProtocolRequest::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.enableCell) {
    xfer += oprot->writeFieldBegin("enableCell", ::apache::thrift::protocol::T_BOOL, 7);
    xfer += oprot->writeBool(this->enableCell);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
const char* ProtocolResponse::ascii_fingerprint = "862C486843307C97BAF2EC02302BDDAE";
const uint8_t ProtocolResponse::binary_fingerprint[16] = {0x86,0x2C,0x48,0x68,0x43,0x30,0x7C,0x97,0xBA,0xF2,0xEC,0x02,0x30,0x2B,0xDD,0xAE};
