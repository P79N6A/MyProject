...
#define LOG_DEBUG(debugContent) {LOG4CPLUS_DEBUG(debug_instance, debugContent);}
#define LOG_INFO(infoContent) {LOG4CPLUS_INFO(info_instance, infoContent);}
#define LOG_WARN(warnContent) {LOG4CPLUS_WARN(warn_instance, warnContent);}
#define LOG_ERROR(errorContent) {LOG4CPLUS_ERROR(error_instance, errorContent);}
#define LOG_FATAL(fatalContent) {LOG4CPLUS_ERROR(fatal_instance, fatalContent);}
