...
public interface Tag {
    ...
    /**
     * Return the containing {@link com.sun.javadoc.Doc} of this Tag element.
     */
    Doc holder();
     ...
     * {@link com.sun.javadoc.SeeTag} of name "@link" and kind "@see".
     ...
     * <ul>
     *    <li> tags[0] is a {@link com.sun.javadoc.Tag} with name "Text" and text consisting
     *         of "This is a "
     *    <li> tags[1] is a {@link com.sun.javadoc.SeeTag} with name "@link", referenced
     *         class <code>Doc</code> and label "commentlabel"
     *    <li> tags[2] is a {@link com.sun.javadoc.Tag} with name "Text" and text consisting
     *         of " example."
     * </ul>
     *
     ...
     * block tags.
     * Each section of plain text is represented as a {@link com.sun.javadoc.Tag}
     * of kind "Text".
     * Inline tags are represented as a {@link com.sun.javadoc.SeeTag} of kind "@link".
     ...
     * determined by
     * {@link java.text.BreakIterator#getSentenceInstance(java.util.Locale)}.
     *
     * @return an array of {@link com.sun.javadoc.Tag} objects representing the
