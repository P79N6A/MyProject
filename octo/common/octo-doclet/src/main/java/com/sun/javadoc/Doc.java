...
public interface Doc extends Comparable<Object> {
     ...
     *
     * @return an array of {@link com.sun.javadoc.Tag} objects containing all tags on
     *         this Doc item.
     */
    Tag[] tags();

    /**
     * Return tags of the specified {@linkplain com.sun.javadoc.Tag#kind() kind} in
     * this Doc item.
     *
     ...
     * of {@linkplain com.sun.javadoc.Tag#kind() kind} "Text".
     * Inline tags are represented as a {@link com.sun.javadoc.SeeTag} of kind "@see"
     * and name "@link".
     *
     * @return an array of {@link com.sun.javadoc.Tag}s representing the comment
     */
    Tag[] inlineTags();
     ...
     * @return an array of {@link com.sun.javadoc.Tag}s representing the
