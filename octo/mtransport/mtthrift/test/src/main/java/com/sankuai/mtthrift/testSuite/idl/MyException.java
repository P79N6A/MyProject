...
public class MyException extends Exception implements org.apache.thrift.TBase<MyException, MyException._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(MyException other) {
    ...
    MyException typedOther = (MyException)other;
