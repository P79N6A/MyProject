...
public class TweetSearchResult implements org.apache.thrift.TBase<TweetSearchResult, TweetSearchResult._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TweetSearchResult other) {
    ...
    lastComparison = Boolean.valueOf(isSetTweets()).compareTo(typedOther.isSetTweets());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTweets()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.tweets, typedOther.tweets);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
