...
public class BalancerTest {
    ...
    @Test
    public void userDefinedBalancer() {int count = 1000000;
        final String ip1 = "1.1.1.1";
        final String ip2 = "2.2.2.2";
        final String ip3 = "3.3.3.3";
        final String ip4 = "4.4.4.4";
        ...
        MyBalancer loadBalancer = new MyBalancer();
        List<ServerConn> serverList = new ArrayList<ServerConn>();
    ...
    public class MyBalancer extends AbstractLoadBalancer {

        @Override
        public ServerConn doSelect(List<ServerConn> list, MethodInvocation methodInvocation) {
