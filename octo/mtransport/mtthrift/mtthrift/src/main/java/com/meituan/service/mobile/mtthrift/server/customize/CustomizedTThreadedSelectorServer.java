 ...
 * Time: 上午10:51
 */
public class CustomizedTThreadedSelectorServer extends CustomizedAbstractNonblockingServer {

    private static final Logger LOGGER = LoggerFactory.getLogger(CustomizedTThreadedSelectorServer.class.getName());

    public static class Args extends CustomizedAbstractNonblockingServerArgs<Args> {
     ...
     */
    public CustomizedTThreadedSelectorServer(Args args, String appkey, ConfigStatus configStatus) {
        super(args, appkey, configStatus);
        args.validate();
    ...
    protected Runnable getRunnable(FrameBuffer frameBuffer) {
        return new CustomizedInvocation(frameBuffer);
    }
    ...
    protected class AcceptThread extends Thread {
        ...
        public void run() {
            try {
                ...
                LOGGER.error("run() exiting due to uncaught error", e);
            } finally {
                // This will wake up the selector threads
                CustomizedTThreadedSelectorServer.this.stop();
            }
        }
