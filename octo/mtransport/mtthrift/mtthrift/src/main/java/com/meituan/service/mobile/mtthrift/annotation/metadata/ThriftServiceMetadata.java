...
public class ThriftServiceMetadata
{
    ...
    public boolean equals(Object obj)
    {
        ...
        return Objects.objectEqual(this.name, other.name) && Objects.objectEqual(this.methods, other.methods) && Objects.objectEqual(this.parentServices, other.parentServices);
    }
}
