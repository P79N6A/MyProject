 ...
 * under the License.
 */
package com.meituan.service.mobile.mtthrift.annotation.metadata;
...
import com.meituan.service.mobile.mtthrift.util.Objects;
...
public class ThriftMethodMetadata
{
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.objectEqual(name, that.name) && Objects.objectEqual(returnType, that.returnType) &&
                Objects.objectEqual(parameters, that.parameters) && Objects.objectEqual(method, that.method) &&
                Objects.objectEqual(exceptions, that.exceptions) && Objects.objectEqual(oneway, that.oneway);
    }
