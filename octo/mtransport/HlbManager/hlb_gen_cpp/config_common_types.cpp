...
const char* ConfigGroup::ascii_fingerprint = "00D1005519622F4536E85FC5DF2DD4BD";
const uint8_t ConfigGroup::binary_fingerprint[16] = {0x00,0xD1,0x00,0x55,0x19,0x62,0x2F,0x45,0x36,0xE8,0x5F,0xC5,0xDF,0x2D,0xD4,0xBD};
...
const char* ConfigGroups::ascii_fingerprint = "B769E7336EC05FE184B096C54FE0B616";
const uint8_t ConfigGroups::binary_fingerprint[16] = {0xB7,0x69,0xE7,0x33,0x6E,0xC0,0x5F,0xE1,0x84,0xB0,0x96,0xC5,0x4F,0xE0,0xB6,0x16};
...
const char* ConfigNode::ascii_fingerprint = "FDCF698C11F614746E5767C538F90A18";
const uint8_t ConfigNode::binary_fingerprint[16] = {0xFD,0xCF,0x69,0x8C,0x11,0xF6,0x14,0x74,0x6E,0x57,0x67,0xC5,0x38,0xF9,0x0A,0x18};
...
const char* GetMergeDataRequest::ascii_fingerprint = "F2E1A005750F45C40E569DE289D8A980";
const uint8_t GetMergeDataRequest::binary_fingerprint[16] = {0xF2,0xE1,0xA0,0x05,0x75,0x0F,0x45,0xC4,0x0E,0x56,0x9D,0xE2,0x89,0xD8,0xA9,0x80};
...
const char* ConfigFileResponse::ascii_fingerprint = "93CC3D1E71866966C22792AABF4C3815";
const uint8_t ConfigFileResponse::binary_fingerprint[16] = {0x93,0xCC,0x3D,0x1E,0x71,0x86,0x69,0x66,0xC2,0x27,0x92,0xAA,0xBF,0x4C,0x38,0x15};
...
uint32_t ConfigFileResponse::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.hosts) {
    xfer += oprot->writeFieldBegin("hosts", ::apache::thrift::protocol::T_LIST, 2);
    {
      ...
      for (_iter37 = this->hosts.begin(); _iter37 != this->hosts.end(); ++_iter37)
      {
...
const char* ConfigGroupResponse::ascii_fingerprint = "C9785261D31221DD6B5E983A82C8EDF3";
const uint8_t ConfigGroupResponse::binary_fingerprint[16] = {0xC9,0x78,0x52,0x61,0xD3,0x12,0x21,0xDD,0x6B,0x5E,0x98,0x3A,0x82,0xC8,0xED,0xF3};
...
const char* ConfigGroupsResponse::ascii_fingerprint = "A4186F6C499BDB410DD93CB3D5BB113D";
const uint8_t ConfigGroupsResponse::binary_fingerprint[16] = {0xA4,0x18,0x6F,0x6C,0x49,0x9B,0xDB,0x41,0x0D,0xD9,0x3C,0xB3,0xD5,0xBB,0x11,0x3D};
