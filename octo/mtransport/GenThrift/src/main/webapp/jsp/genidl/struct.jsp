...
<head>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#cleanStruct").click(function () {
                $.get("/genidl/cleanStruct", function (data, status) {
                    location.href = '/genidl/struct'
                })
        ...
        function addStruct() {
            ...
            pNode.innerHTML = "类型：<select name='variableType" + count + "' class='form-control' style='display: inline-block;width: 80px;'> " +
                    "<option>i32</option>" +
                    "<option>i64</option>" +
            ...
            pNode.innerHTML += "&nbsp;&nbsp;&nbsp;&nbsp;变量名：<input type='text' name='variableName" + count + "' placeholder='variable' required autofocus style='width: 100px'>";

            pNode.innerHTML += "&nbsp;&nbsp;&nbsp;&nbsp;默认值(选填)：    " + "<input type='text' name='variableValue" + count + "' placeholder='value' style='width: 120px'>";
...
<div class="container">
    <form action="/genidl/struct" method="post">
        <br>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <br><br>
                <span class="label label-success" style="border-radius: 50%">3</span>&nbsp;&nbsp;
                <button type="button" class="btn btn-default" onclick="addStruct()">添加结构体成员 &raquo;</button>

                &nbsp;&nbsp;&nbsp;&nbsp;结构体名：<input type='text' name='structName' placeholder='name' required autofocus
                                                    style='width: 100px'>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input id="cleanStruct" type="button" class="btn btn-default" value="清空结构体"/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
