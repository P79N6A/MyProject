...
public class CthriftClient {
    ...
    public CthriftClient(int threadNum, long msgCount, int msgLength, String msgType) {
    ...
    public void test() {
        ...
        clientBeanFactory = new ClassPathXmlApplicationContext("cthrift/client.xml");
        ...
        logger.info("*****cthrift:ThreadNum:" + threadNum + " MsgCount:" + msgCount + " MsgLength:" + msgLength + " MsgType:" + msgType + "*****");
