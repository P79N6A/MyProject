...
// * Time: 下午5:46
// */
//public class OctoFutureClient {
//
//    private final static Logger logger = LoggerFactory.getLogger(OctoFutureClient.class);
//
...
//    }
//
//    public OctoFutureClient(int threadNum, long msgCount, int msgLength, String msgType) {
...
//
//        logger.info("*****OctoFuture:ThreadNum:" + threadNum + " MsgCount:" + msgCount + " MsgLength:" + msgLength + " MsgType:" + msgType + "*****");
