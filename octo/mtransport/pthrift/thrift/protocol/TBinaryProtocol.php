...
include_once $GLOBALS['THRIFT_ROOT'].'/protocol/RequestHeader.php';
...
class TBinaryProtocol extends TProtocol {
  ...
  protected $header_;   //RequestHeader
  protected $isSetHeader_ = false;
  ...
  public function __construct($trans, $strictRead=false, $strictWrite=true) {
    ...
    $this->header_ = new RequestHeader();
    $this->isSetHeader_ = false;
  }

  public function setHeader($header)
  {
      $this->header_ = $header;
      $this->isSetHeader_ = true;
  }

  public function writeMessageBegin($name, $type, $seqid) {
    if ($this->strictWrite_) {
      $version = self::VERSION_1 | $type;
      if($this->isSetHeader_)
      {
          $this->isSetHeader_ = false;
          return
            ...
            $this->writeI32($seqid) + 
            $this->writeFieldBegin('mtrace', TType::STRUCT, 32767) + 
            $this->header_->write($this) +
            $this->writeFieldEnd(); 
      }
      else
      {
