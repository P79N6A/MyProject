...
class UserGeoReq {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('UserGeoReq');
    if ($this->uuid !== null) {
    ...
    if ($this->debug !== null) {
      $xfer += $output->writeFieldBegin('debug', TType::I32, 5);
...
class RecGeo {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('RecGeo');
    ...
    if ($this->indextype !== null) {
      $xfer += $output->writeFieldBegin('indextype', TType::I32, 6);
      $xfer += $output->writeI32($this->indextype);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->tag !== null) {
      $xfer += $output->writeFieldBegin('tag', TType::STRING, 7);
...
class UserGeoRes {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('UserGeoRes');
    if ($this->geo_list !== null) {
      ...
      $xfer += $output->writeFieldBegin('geo_list', TType::LST, 1);
      {
        ...
        {
          foreach ($this->geo_list as $iter6)
          {
    ...
    if ($this->debug !== null) {
      $xfer += $output->writeFieldBegin('debug', TType::I32, 3);
      $xfer += $output->writeI32($this->debug);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
