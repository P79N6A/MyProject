...
public class BetterExecutorService extends AbstractExecutorService {
    ...
    private final Logger logger = LoggerFactory
            .getLogger(BetterExecutorService.class);
    ...
    public BetterExecutorService(
        ...
        for (int i = 0; i < maxDrainers; i++) {
            drainerList.add(new Drainer(
                    String.format("%s-%03d", this.poolName, i)));
        }
    }
    ...
    public BetterExecutorService(
        ...
        this(workQueue, executor, "Drainer", maxDrainers, maxTimeSlice,
                maxTimeSliceUnit);
    }
    ...
    public BetterExecutorService(
        ...
        this(workQueue, executor, poolName, maxDrainers, Long.MAX_VALUE,
    ...
    public BetterExecutorService(
        ...
        this(workQueue, executor, "Drainer", maxDrainers, Long.MAX_VALUE,
                TimeUnit.MILLISECONDS);
    }
