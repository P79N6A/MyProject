...
class EchoIf {
 public:
  virtual ~EchoIf() {}
  virtual void echo(std::string& _return, const std::string& arg) = 0;
};
...
typedef struct _Echo_echo_args__isset {
  _Echo_echo_args__isset() : arg(false) {}
  bool arg;
...
class EchoClient : virtual public EchoIf {
 public:
  ...
  void echo(std::string& _return, const std::string& arg);
  void send_echo(const std::string& arg);
