...
int _kCallTypeValues[] = {
        Cthrift_CallType::Reply,
        Cthrift_CallType::NoReply
};
...
int _kStatusCodeValues[] = {
  StatusCode::Success,
  StatusCode::ApplicationException,
  StatusCode::RuntimeException,
  StatusCode::RpcException,
  StatusCode::TransportException,
  StatusCode::ProtocolException,
  StatusCode::DegradeException,
  StatusCode::SecurityException,
  StatusCode::ServiceException,
  StatusCode::RemoteException
};
...
const std::map<int, const char*> _StatusCode_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(10, _kStatusCodeValues, _kStatusCodeNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
