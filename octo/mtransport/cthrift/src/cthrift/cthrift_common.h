...
//非法的指针，用来做cmtrace里面获取上下文信息的判断
#define ILLEGAL_PRT 0x1
...
typedef std::map<std::string, StrStrMap> StrSMMap;
...
int ParseJsonToMapX(const std::string &str_json, StrStrMap& map);

static const std::string version = "cthrift-v2.9.0";
} // cthrift
