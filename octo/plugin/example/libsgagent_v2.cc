...
OUTAPI void DestroyProcessorObject() {
  LOG(INFO) << "Sgagent_v2 destroy processor object.";
  if (g_processor) {
    delete g_processor;
    g_processor = NULL;
  }
