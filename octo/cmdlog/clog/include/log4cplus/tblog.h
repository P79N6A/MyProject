...
#define TBSYS_LOG_LEVEL_CLOSE 0
#define TBSYS_LOG_LEVEL_ERROR 1
#define TBSYS_LOG_LEVEL_WARN  2
#define TBSYS_LOG_LEVEL_INFO  3
#define TBSYS_LOG_LEVEL_DEBUG 4
...
#define TBSYS_LOGGER cmdlog::CLogger::_logger
...
#define TBSYS_LOG_US(level, _fmt_, args...) \
  ((TBSYS_LOG_LEVEL_##level>TBSYS_LOGGER._level) ? (void)0 : TBSYS_LOG_BASE(level, "[%ld][%ld][%ld] " _fmt_, \
                                                            pthread_self(), cmdlog::CLogger::get_cur_tv().tv_sec, \
                                                            cmdlog::CLogger::get_cur_tv().tv_usec, ##args))
