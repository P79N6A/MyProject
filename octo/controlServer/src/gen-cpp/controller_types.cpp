...
const std::map<int, const char*> _HealthEnum_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(3, _kHealthEnumValues, _kHealthEnumNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
